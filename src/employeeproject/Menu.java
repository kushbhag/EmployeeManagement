...
public class Menu extends javax.swing.JFrame {
   ...
   // AddEmployee addEmp = new AddEmployee(hashTable);
    ...
    public Menu(MyHashTable copyHash){
        initComponents();
        hashTable = copyHash;
    }
    public void addEmp (EmployeeInfo empInfo){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        dispose();
        new DisplayEmployee(hashTable).setVisible(true);        
 ...
 //PROBLEM IS THAT EACH CLASS CALLS EACH OTHER IN INFINITE LOOP